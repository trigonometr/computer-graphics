...
int main(void)
{
	...
	GLuint programID = LoadShaders("AwesomeVertexShader.vertexshader", "AwesomeFragmentShader.fragmentshader");
	...
	GLuint vertexbuffer = CreateVBO(g_vertex_buffer_data, sizeof(g_vertex_buffer_data));
	GLuint colorbuffer = CreateVBO(g_color_buffer_data, sizeof(g_color_buffer_data));
